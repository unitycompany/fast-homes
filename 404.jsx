...
import GlobalButton2 from './src/components/buttons/GlobalButton2';
  ...
  return (
    <StyledWrapper>
              ...
              <div className="screen_out">
                <div className="screen_out1">
                  <div className="screen">
                    <span className="notfound_text"> Página não encontrada</span>
                  </div>
      ...
      <div className="redirect">
        <p>Redirecionando<b>{countdown}</b></p>
        <GlobalButton2
                text="Voltar para a o inicio"
                background1="#000"
                background2="#000"
                colorIcon="#fff"
                colorText="#fff"
